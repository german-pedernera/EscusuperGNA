...
const evidenciasData = [
  ...
  const conclusionAudioRef = useRef(null);
  ...
  const introParagraphs = [
    ...
    "Somos un grupo integrado por: Raúl Dirie, Rubén Darío Pérez, Sergio Barrios, Jesica Aguirre y Daniel Rivero estudiantes del Profesorado Universitario."
  ];
  ...
  const playIntroAudio = () => {
    ...
    if (!introAudioRef.current) {
      introAudioRef.current = new Audio('/introduccion.mp4');
    ...
    introAudioRef.current.play()
      ...
      .catch((error) => {
        ...
        showAlert("No se pudo reproducir el audio.");
      });
  };
  ...
  const playNarrativeAudio = () => {
    ...
    if (!narrativeAudioRef.current) {
      narrativeAudioRef.current = new Audio('/narrativa.mpeg');
      narrativeAudioRef.current.onended = () => {
        setIsNarrativeSpeaking(false);
      };
    }
    ...
    narrativeAudioRef.current.play()
      ...
      .catch((error) => {
        ...
        showAlert("No se pudo reproducir el audio de la narrativa.");
      });
  };
  ...
  const playConclusionAudio = () => {
    ...
    if (!conclusionAudioRef.current) {
      conclusionAudioRef.current = new Audio('/conclucion.mp4');
      conclusionAudioRef.current.onended = () => {
        setIsConclusionSpeaking(false);
      };
    }
    ...
    conclusionAudioRef.current.play()
      ...
      .catch((error) => {
        console.error("Error playing conclusion audio:", error);
        showAlert("No se pudo reproducir el audio de la conclusión.");
      });
  };
  ...
  return (
    <>
      ...
      <main>
          ...
          <div className="intro-grid fade-up delay-200">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
              <div className="intro-stats">
                ...
                >
                  <div className="stat-number" style={{ color: isIntegrantesHovered ? '#ffffff' : '' }}>5</div>
        ...
        <section id="narrativa" className="section narrativa-section" style={{ backgroundColor: 'var(--bg-light)' }}>
          <div className="fade-up" style={{ margin: '0' }}>
            <div className="responsive-header" style={{ padding: '0 20px' }}>
              <div className="responsive-header-text">
                <h2 className="section-title responsive-title">NARRATIVA INTEGRADORA FINAL</h2>
                <p className="section-description" style={{ margin: 0 }}>Nuestro recorrido de aprendizaje y conclusión</p>
              </div>
              <button 
                className="btn btn-primary responsive-audio-btn" 
                onClick={playNarrativeAudio} 
                style={{ backgroundColor: isNarrativeSpeaking ? '#e74c3c' : 'var(--primary-orange)' }}
              >
            ...
            <div className="narrativa-card" style={{ backgroundColor: 'var(--card-bg)', borderRadius: '30px', boxShadow: '0 10px 40px rgba(0,0,0,0.08)', display: 'flex', flexDirection: 'column', marginTop: '20px' }}>
          ...
          <div className="fade-up" style={{ width: '100%', maxWidth: '100%', margin: '0' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '20px', padding: '0 20px' }}>
              ...
              >
                ...
                {isConclusionSpeaking ? 'Detener conclusión' : 'Escuchar conclusión'}
              </button>
            </div>
        ...
        <section id="conclusion-final" className="section fade-up" style={{ padding: '20px 40px 60px', backgroundColor: 'var(--bg-light)' }}>
          <div style={{ 
            maxWidth: '1200px', 
            margin: '0 auto', 
            ...
            borderLeft: '10px solid var(--primary-orange)',
